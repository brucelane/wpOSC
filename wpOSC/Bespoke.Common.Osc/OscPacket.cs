...
namespace Bespoke.Common.Osc
{
	...
	public abstract class OscPacket
	{
		...
		public void Send(IPEndPoint destination)
		{
			...
			sUdpClient.Send(data, destination);
		}
		...
		public static byte[] ValueToByteArray<T>(T value)
		{
			...
			switch (type.Name)
			{
				...
				case "String":
                    // was ASCII, but WP7 doesn't support it
        ...
        private static byte[] SwapEndian(byte[] data)
        {
        ...
        /// </summary>
        protected static bool sLittleEndianByteOrder = false;
